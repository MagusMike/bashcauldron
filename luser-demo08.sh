...
# Redirect STDOUT to afile, overwriting the file
...
head -n3 /etc/passwd /fake/file &> ${FILE}
echo
echo "Contents of ${FILE}"
cat ${FILE}
...
head -n3 /etc/passwd /fake/file > /dev/null

# Discard STDERR 
echo
echo "Discarding STDERR:"
head -n3 /etc/passwd /fake/file 2> /dev/null
