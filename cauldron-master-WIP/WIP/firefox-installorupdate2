...
main(){
  ...
  local latestVersionUrl='https://www.mozilla.org/en-US/firefox/new/'
  local latestDownloadUrl='https://download.mozilla.org/?product=firefox-latest-ssl&os=osx&lang=en-US'
  local applicationPath="/Applications/${applicationName}.app"
  local installedVersion
  local latestVersion
