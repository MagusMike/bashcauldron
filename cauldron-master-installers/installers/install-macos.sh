...
OSInstaller="/Applications/Install macOS Big Sur.app"
...
download_trigger="download-bigsur"
...
take up to 1 hour depending on the speed of your internet connection. The installation \
...
## Begin Upgrade
startosinstallCommand=$(echo $adminpass | \"$OSInstaller/Contents/Resources/startosinstall\" ${startosinstallOptions[*]} >> $osinstallLogfile 2>&1 &)
